...
add_text("MALORIAN ARMS  NIGHT CITY", 0.0075, 0.0216, 0.285, 0.048, "txt_nightcity")
...
DOT_Y0 = 0.756          # rearmost dot column (cap chamfer starts ~0.776)
DOT_STEP = 0.0060
for r in range(2):
    for c in range(4):
        if r == 1 and c == 3:
...
for name, (loc, rot) in views.items():
    ...
    scene.render.filepath = os.path.join(outdir, "v12_" + name + ".png")
    bpy.ops.render.render(write_still=True)
    print("RENDERED", name)
print("KITBASH V12 DONE")
