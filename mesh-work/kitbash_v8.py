"""Dioscuri kitbash v8 — branding corrections per reference:
...
p_tube     = probe(0.60, 0.78, 0.09, 0.16)     # barrel tube, toward the muzzle
...
add_text("MALORIAN", 0.014, tx - 0.0008, 0.615, tz - 0.006, "txt_malorian", spacing=1.15)
...
for name, (loc, rot) in views.items():
    ...
    scene.render.filepath = os.path.join(outdir, f"v8_{name}.png")
    bpy.ops.render.render(write_still=True)
    print("RENDERED", name)
print("KITBASH V8 DONE")
